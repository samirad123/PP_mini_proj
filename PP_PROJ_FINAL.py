...
registration_form_label.place(x=460, y=30)
...
fullname_label.place(x=430, y=100)
...
fullname_entrytext.place(x=570, y=100)
...
slot_optionmenu.place(x=570, y=150)
...
user_location.place(x=430, y=200)
...
state_optionmenu.place(x=570, y=200)
...
email_entrytext.place(x=570, y=300)

#Choose date
cal_label=Label(frame2,text="DATE :")
cal_label["font"]=("Calibri",15,"bold")
cal_label.place(x=460,y=350)
cal_label["fg"]="#00f3b2"
cal_label["bg"]="#310054"

min_date=date(2021,10,14)
max_date=date(2021,11,30)
var_sel_date=StringVar()
cal=Calendar(frame2,selectmode="day",mindate=min_date,maxdate=max_date,textvariable=var_sel_date,date_pattern="dd/mm/yy")
cal["font"]=("Al Bayan",10)
cal["bordercolor"]="#00f3b2"
cal["background"]="#310054"
cal["foreground"]="#310054"
cal["headersbackground"]="#310054"
cal["headersforeground"]="#310054"
cal["normalbackground"]="#310054"
cal["normalforeground"]="#ffa500"
cal["weekendbackground"]="#310054"
cal["weekendforeground"]="red"
cal["othermonthbackground"]="#333333"
cal["othermonthforeground"]="#310054"
cal["othermonthwebackground"]="#333333"
cal["othermonthweforeground"]="#310054"
cal["disableddaybackground"]="grey"
cal["disableddayforeground"]="grey"
cal["selectbackground"]="#00f3b2"
cal["selectforeground"]="#310054"
cal.place(x=567,y=350)

#Label to display chosen date
var_date_text=StringVar()
l_date_text=Label(frame2,font=("Calibri",15,"bold"),bg="#310054",fg="#00f3b2",textvariable=var_date_text)
l_date_text.place(x=400,y=550)

def choose_date():
    chosen_date_text=f"Reservation Date : {cal.get_date()}"
    var_date_text.set(chosen_date_text)

#Choose date button
b_con_date=Button(frame2,text="Choose Date",command=choose_date,width=20,fg="#00f3b2",highlightbackground="#310054")
b_con_date.place(x=910,y=500)

# Submit Button
button_submit = tk.Button(frame2, text="Submit", command=reg_form_submit)
button_submit.place(x=1030, y=600)
...
def mcd_get_order():
    ...
    txtfile.close()
    date_confirm=f"Date :\t{cal.get_date()}"
    var_date_confirm.set(date_confirm)
...
var_date_confirm=StringVar()
l_date=Label(frame9,textvariable=var_date_confirm,bg="#310054", fg="#00f3b2", font=['Calibri', 20, 'bold'])
l_date.place(x=260,y=250)

# Time Slot Confirmation Label
var_time = StringVar()
l_time = Label(frame9, textvariable=var_time, bg="#310054", fg="#00f3b2", font=['Calibri', 20, 'bold'])
l_time.place(x=260, y=300)
